...
```
```{r}
# Nicer print-out using kable
kable(summary(df.nlsy.lm)$coef, digits = c(3, 3, 3, 5))
```


Variable "growth", "grade, "gender" and "family size" are significant in expaining the depedent variable "income".
Holding every other influencers constant, one unit of increase in the number of jobs a specific candidate had from year 1990 to 2012 will decrease average income by 0.042 unit; 
one unit of increase in the grade completed in 2012 will lead to a 0.1 unit increase in the salary; 
Male's income is on average 0.36 more than that of female; 
one unit of increase in family size will lead to a 0.02 unit increase in the salary;   
